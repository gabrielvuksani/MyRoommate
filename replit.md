...
- ✓ Fixed glass card alignment issues and removed all borders/outlines from message input
- ✓ Resolved textarea background transparency issues by excluding from global textarea styles
- ✓ Identified and removed inset box-shadows from glass-card that created border appearance
