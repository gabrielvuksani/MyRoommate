      ...
      <div className="page-content space-y-6">
        ...
        <div className="mb-8">
          <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
            ...
            Today's Priority
            <span className="ml-2 px-2 py-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs rounded-full">AI</span>
          </h2>
                    ...
                    <div className="space-y-2">
                      {(() => {
                        ...
                        return priorityChores.length > 0 ? priorityChores.map((chore: any) => (
                          ...
                          <p className="text-sm text-gray-600">No pending chores</p>
                        );
                      })()}
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {(() => {
              ...
              const memberPerformance = household?.members?.map((member: any) => {
                const memberChores = chores.filter((c: any) => c.assignedTo === member.userId);
