    ...
    mutationFn: async (listingData: any) => {
      const data = {
        ...
        utilities: listingData.utilities
          ? parseInt(listingData.utilities)
          : null,
  ...
  return (
    <div className="min-h-screen bg-background page-transition">
      ...
      <div className="content-with-header-compact px-6 space-y-6 pb-32">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewListing({ ...newListing, zipCode: e.target.value })
                    }
                  />
                </div>
              </div>
            ...
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <p
                  ...
                  style={{ color: "var(--text-secondary)" }}
                >
                  Set your rent and availability
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewListing({ ...newListing, roomType: value })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewListing({ ...newListing, housingType: value })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewListing({ ...newListing, genderPreference: value })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                ...
                <Select
                  value={newListing.studentYear}
                  onValueChange={(value) =>
                    setNewListing({ ...newListing, studentYear: value })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                ...
                <Select
                  value={newListing.studyHabits}
                  onValueChange={(value) =>
                    setNewListing({ ...newListing, studyHabits: value })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                ...
                <Select
                  value={newListing.socialPreferences}
                  onValueChange={(value) =>
                    setNewListing({ ...newListing, socialPreferences: value })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {lifestyleOptions.map((option) => (
                    ...
                    >
                      <Checkbox
                        id={option.value}
                        checked={newListing.lifestylePreferences.includes(
                          option.value,
                        )}
        ...
        {/* Submit Button */}
        <div
          className="sticky bottom-0 pt-4 pb-8"
