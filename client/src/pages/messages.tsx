                  ...
                  <div className="text-center space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {conversationStarters.map((starter, index) => (
                        <button
                          key={index}
                          className="glass-card p-4 text-left flex items-center gap-4 rounded-2xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 cursor-pointer group min-h-[72px]"
                          onClick={() => handleStarterClick(starter.text)}
                          style={{
                            animation: `modal-enter 0.3s ease-out ${index * 0.05}s backwards`
                          }}
                        >
                          <div className={`w-10 h-10 rounded-xl bg-gradient-to-br ${starter.color} flex items-center justify-center flex-shrink-0 shadow-lg group-hover:shadow-xl transition-shadow duration-200 ml-0`}>
