  ...
  app.post('/api/roommate-listings/demo', async (req: any, res) => {
    try {
      ...
      const demoListing = await storage.createRoommateListing({
        title: "Spacious Master Bedroom in Modern Loft",
        description: "Stunning master bedroom with ensuite bathroom available in a newly renovated industrial loft. Features exposed brick walls, hardwood floors, floor-to-ceiling windows with amazing city views, and a private balcony. The shared spaces include a gourmet kitchen, cozy living room with fireplace, and rooftop terrace. Perfect for graduate students or young professionals who value both comfort and style. Walking distance to campus, restaurants, and nightlife.",
        rent: 1450,
        utilities: 175,
        location: "456 Arts District Boulevard, Unit 302",
        city: "Berkeley",
        state: "CA",
        zipCode: "94709",
        ...
        lifestylePreferences: ["clean", "pet_friendly", "vegetarian", "no_smoking"],
        amenities: ["WiFi", "Laundry", "Kitchen", "Parking", "Gym", "Near Campus", "Public Transport", "Furnished", "Dishwasher"],
        images: ["data:image/svg+xml;base64,"],
        contactInfo: "sarah.martinez@berkeley.edu",
        featured: true,
        createdBy: null,
      });
